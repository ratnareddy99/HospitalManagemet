...
<form action="/hospital/savedoc" method="post">
    <table class="table table-bordered">
        <tbody>
            ...
            <tr><td colspan="2"><input type="submit" value="Add Doctor" class="btn btn-success"></tr>
        </tbody>
    </table>
</form>
<a href="/hospital/login" class="btn btn-success">Back</a>
